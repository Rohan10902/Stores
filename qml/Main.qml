...
ApplicationWindow {
    ...
    title: "Store Data Assistant 7.1.4"
    color: "#07111f"
    property int page: 0
    ...
    header: Rectangle {
        ...
        RowLayout {
            ...
            Column {
                Text{text:"Store Data Assistant 7.1.4";color:"#f8fafc";font.pixelSize:15*root.uiScale;font.bold:true}
    ...
    footer: Rectangle {
        ...
        RowLayout { anchors.fill:parent;anchors.leftMargin:12;anchors.rightMargin:12
            ...
            Text{text:"7.1.4 FILE CREATOR";color:"#94a3b8";font.pixelSize:9}
        }
    }
    RowLayout {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Repeater {
                    model:["Home","Compare & Validate","Review One File","Create Store File","Repair CSV / Text","Data Health & Statistics","Explore & Analyze"]
                    delegate:Button {
