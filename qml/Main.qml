...
ApplicationWindow {
    ...
    minimumWidth: 900; minimumHeight: 620
    ...
    header: Rectangle {
        ...
        RowLayout {
            ...
            Button { text: root.sidebarOpen ? "☰" : "☷"; implicitWidth:38; onClicked:root.sidebarOpen=!root.sidebarOpen }
            Rectangle { width:34; height:34; radius:8; color:"#3b82f6"; Text{anchors.centerIn:parent;text:"SL";color:"white";font.bold:true} }
            Column {
                Text{text:"StoreLens 7.2.1";color:"#f8fafc";font.pixelSize:15*root.uiScale;font.bold:true}
    ...
    footer: Rectangle {
        ...
        RowLayout { anchors.fill:parent;anchors.leftMargin:12;anchors.rightMargin:12
            ...
            Text{text:"StoreLens 7.2.1";color:"#94a3b8";font.pixelSize:9}
        }
    }
    ...
    RowLayout {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Text{text:"Source files remain unchanged until you explicitly export.";color:"#94a3b8";font.pixelSize:9;wrapMode:Text.WordWrap;Layout.fillWidth:true}
            }
        }
        StackLayout {
