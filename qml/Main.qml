...
ApplicationWindow {
    ...
    title: "Store Data Assistant 7.0.2"
    color: "#07111f"
    property int page: 0
    ...
    header: Rectangle {
        ...
        RowLayout {
            ...
            Column {
                Text{text:"Store Data Assistant 7.0.2";color:"#f8fafc";font.pixelSize:15*root.uiScale;font.bold:true}
    ...
    footer: Rectangle {
        ...
        RowLayout { anchors.fill:parent;anchors.leftMargin:12;anchors.rightMargin:12
            ...
            Text{text:"7.0.2 TEST BUILD";color:"#94a3b8";font.pixelSize:9}
        }
    }
    RowLayout {
