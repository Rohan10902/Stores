...
Item{
 ...
 ScrollView{anchors.fill:parent;contentWidth:availableWidth;ColumnLayout{width:parent.width;spacing:14;Item{implicitHeight:18}PageTitle{text:"Data Workspace";Layout.leftMargin:25}Text{text:"7.1.4 SAFE BOOT — 7.1.3 interface restored while new modules are isolated for diagnosis.";color:"#94a3b8";Layout.leftMargin:25;Layout.rightMargin:25;wrapMode:Text.WordWrap}
