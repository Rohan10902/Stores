...
Item{
 ...
 ScrollView{anchors.fill:parent;contentWidth:availableWidth;ColumnLayout{width:parent.width;spacing:14;Item{implicitHeight:18}PageTitle{text:"Data Workspace";Layout.leftMargin:25}Text{text:"7.0.1 test build — safer comparison, auditable repair, health scoring, statistics and tabular exploration.";color:"#94a3b8";Layout.leftMargin:25;Layout.rightMargin:25;wrapMode:Text.WordWrap}
