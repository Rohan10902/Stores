...
Item {
    ...
    function calculateStats() {
        if (root.backendAvailable() && root.selectedColumn !== "")
    ...
    ScrollView {
        ...
        ColumnLayout {
            ...
            PageTitle {
                ...
                title: "Data Health"
                subtitle: "Profile your dataset, calculate statistics, and inspect data quality."
            }
            ...
            Card {
                visible: root.statsData && Object.keys(root.statsData).length > 0
                Layout.fillWidth: true
                Layout.leftMargin: Theme.spacingXLarge
                Layout.rightMargin: Theme.spacingXLarge
                Layout.preferredHeight: Math.max(150, Math.min(380, 120 + root.statRows().length * 42))
                ColumnLayout {
                    anchors.fill: parent
                    anchors.margins: Theme.spacingMedium
                    ...
                    RowLayout {
                        ...
                        Text { text: "Operation: " + String(root.statsData.operation || ""); color: Theme.info }
                    }
                    ListView {
                        id: statsList
                        Layout.fillWidth: true
            ...
            Card {
                ...
                Layout.leftMargin: Theme.spacingXLarge
                Layout.rightMargin: Theme.spacingXLarge
                Layout.preferredHeight: Math.max(170, Math.min(430, 110 + Object.keys(root.healthData).length * 38))
                ColumnLayout {
                    anchors.fill: parent
                    anchors.margins: Theme.spacingMedium
            ...
            Card {
                ...
                ColumnLayout {
                    ...
                    RowLayout {
                        Layout.fillWidth: true
                        Text { text: "Data Preview"; color: Theme.textPrimary; font.pixelSize: 15; font.bold: true }
                        Item { Layout.fillWidth: true }
                        Text { text: root.displayedRows + " displayed"; color: Theme.textSecondary; font.pixelSize: 11 }
                    }
                    Rectangle {
                        Layout.fillWidth: true
                        Layout.fillHeight: true
