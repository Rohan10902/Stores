...
Item {
    ...
    function backendAvailable() {
        return typeof backend !== "undefined" && backend !== null &&
               backend.health !== undefined && backend.health !== null
    }
    ...
    function rowValue(row, column) {
        ...
        if (Array.isArray(row)) {
            var arrayIndex = root.columns.indexOf(column)
            return arrayIndex >= 0 && arrayIndex < row.length && row[arrayIndex] !== null && row[arrayIndex] !== undefined
                    ? String(row[arrayIndex]) : ""
        }
        ...
        ColumnLayout {
            ...
            Card {
                ...
                RowLayout {
                    ...
                    TextField { Layout.fillWidth: true; readOnly: true; text: root.sourcePath; placeholderText: "Select CSV or spreadsheet"; color: Theme.textPrimary }
                    AppButton { text: "Browse"; onClicked: fileDialog.open() }
                    PrimaryButton { text: "Load"; enabled: root.sourcePath !== ""; onClicked: root.loadData() }
                }
            }
                ...
                Repeater {
                    ...
                    delegate: Card {
                        ...
                        ColumnLayout {
                            ...
                            Text { text: modelData.value; color: modelData.tone; font.pixelSize: 22; font.bold: true; Layout.alignment: Qt.AlignHCenter }
                            Text { text: modelData.label; color: Theme.textSecondary; font.pixelSize: 10; font.bold: true; Layout.alignment: Qt.AlignHCenter }
                        }
                    }
                }
            }
            ...
            Card {
                Layout.fillWidth: true; Layout.leftMargin: Theme.spacingXLarge; Layout.rightMargin: Theme.spacingXLarge; Layout.preferredHeight: 120
                ColumnLayout {
                    anchors.fill: parent; anchors.margins: Theme.spacingMedium; spacing: Theme.spacingSmall
                    Text { text: "Search Dataset"; color: Theme.textPrimary; font.pixelSize: 14; font.bold: true }
                    RowLayout {
                        Layout.fillWidth: true
                        ComboBox {
                            id: columnCombo
                            ...
                            onCurrentTextChanged: root.searchColumn = currentIndex <= 0 ? "" : currentText
                        }
                        TextField {
                            Layout.fillWidth: true; placeholderText: "Search for a value..."; text: root.searchText; color: Theme.textPrimary
                            onTextChanged: root.searchText = text
                            onAccepted: root.executeSearch()
                        }
                        PrimaryButton { text: "Search"; enabled: root.searchText.trim() !== ""; onClicked: root.executeSearch() }
                        AppButton { text: "Clear"; onClicked: { root.searchText = ""; root.loadData() } }
                    }
                }
            }
            ...
            Card {
                ...
                ColumnLayout {
                    anchors.fill: parent; anchors.margins: Theme.spacingMedium; spacing: Theme.spacingSmall
                    RowLayout { Layout.fillWidth: true; Text { text: "SQL Query"; color: Theme.textPrimary; font.pixelSize: 14; font.bold: true }; Item { Layout.fillWidth: true }; Text { text: "Run against the loaded dataset"; color: Theme.textSecondary; font.pixelSize: 10 } }
                    TextArea { Layout.fillWidth: true; Layout.fillHeight: true; text: root.sqlText; placeholderText: "SELECT * FROM data LIMIT 100"; color: Theme.textPrimary; wrapMode: TextEdit.NoWrap; onTextChanged: root.sqlText = text }
                    RowLayout { Layout.fillWidth: true; Item { Layout.fillWidth: true }; AppButton { text: "Reset"; onClicked: root.sqlText = "" }; PrimaryButton { text: "Run SQL"; enabled: root.sqlText.trim() !== ""; onClicked: root.executeSql() } }
                }
            }

            Card {
                Layout.fillWidth: true; Layout.leftMargin: Theme.spacingXLarge; Layout.rightMargin: Theme.spacingXLarge; Layout.bottomMargin: Theme.spacingXLarge; Layout.preferredHeight: 650
                ColumnLayout {
                    anchors.fill: parent; anchors.margins: Theme.spacingMedium; spacing: Theme.spacingSmall
                    RowLayout { Layout.fillWidth: true; Text { text: "Data Preview"; color: Theme.textPrimary; font.pixelSize: 15; font.bold: true }; Item { Layout.fillWidth: true }; Text { visible: root.truncated; text: "Showing " + root.displayedRows + " of " + root.totalRows; color: Theme.warning; font.pixelSize: 11 } }
                    ...
                    Rectangle {
                        ...
                        Flickable {
                            ...
                            Column {
                                ...
                                spacing: 0
                                Rectangle {
                                    width: tableColumn.width; height: 40; color: Theme.surfaceHover; border.color: Theme.border
                                    Row {
                                        anchors.fill: parent
                                        Repeater {
                                            model: root.columns
                                            delegate: Rectangle {
                                                ...
                                                width: 160; height: 40; color: "transparent"; border.color: Theme.border
                                                Text { anchors.fill: parent; anchors.margins: 7; text: headerDelegate.modelData; color: Theme.textSecondary; font.bold: true; font.pixelSize: 11; elide: Text.ElideRight; verticalAlignment: Text.AlignVCenter }
                                            }
                                        }
                                    }
                                }
                        ...
                        Text { visible: root.rows.length === 0; anchors.centerIn: parent; text: root.sourcePath === "" ? "Load a dataset to begin." : "No rows returned."; color: Theme.textMuted; font.pixelSize: 13 }
                    }
                }
            }
        }
