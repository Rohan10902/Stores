                        ...
                        Row {
                            ...
                            Repeater {
                                ...
                                delegate: Rectangle {
                                    ...
                                    width: 180; height: 34; color: "#132238"
                                    Text { anchors.fill: parent; anchors.margins: 6; text: String(modelData); color: "#94a3b8"; font.bold: true; elide: Text.ElideRight }
                                }
                            }
                        }
                        Repeater {
                            ...
                            delegate: Rectangle {
                                ...
                                width: tableColumn.width; height: 32
                                ...
                                Row {
                                    ...
                                    Repeater {
                                        ...
                                        delegate: Rectangle {
                                            ...
                                            border.width: 1; border.color: "#17283d"
