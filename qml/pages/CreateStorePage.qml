...
Item {
    ...
    ColumnLayout {
        ...
        Text {
            text: "Fixed output schema. Click a cell and paste directly from Excel / Google Sheets with Ctrl+V."
            color: "#94a3b8"
        }
        ...
        Rectangle {
            ...
            Text {
                anchors.fill: parent
                anchors.margins: 8
                text: validationCount + " value(s) need review before export."
                color: "#fde68a"
